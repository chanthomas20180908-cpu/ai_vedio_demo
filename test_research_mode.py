...
def test_research_modes():
    ...
    test_cases = [
        {
            "name": "产品平台调研",
            "query": "展开网络调研，主要调研AI产品方向",
            "expected_mode": "product"
        },
        {
            "name": "AI新闻调研",
            "query": "展开网络调研，主要调研AI新闻方向",
            "expected_mode": "ai_news"
        },
        {
            "name": "综合调研",
            "query": "展开网络调研，主要调研AI产品和AI新闻方向",
            "expected_modes": ["product", "ai_news"]
        }
    ]
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        try:
            ...
            logger.info(f"\n结果:")
            logger.info(f"- 模型响应: {result.get('content', '')[:500]}...")
            ...
            suggest_url_calls = [
                ...
                if call.get('function', {}).get('name') == 'suggest_url'
            ]
